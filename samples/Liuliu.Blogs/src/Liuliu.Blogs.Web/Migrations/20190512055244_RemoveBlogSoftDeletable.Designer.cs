...
namespace Liuliu.Blogs.Web.Migrations
{
    ...
    [Migration("20190512055244_RemoveBlogSoftDeletable")]
    partial class RemoveBlogSoftDeletable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Liuliu.Blogs.Blogs.Entities.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Liuliu.Blogs.Blogs.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Liuliu.Blogs.Blogs.Entities.Blog", b =>
                {
                    b.HasOne("Liuliu.Blogs.Identity.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Liuliu.Blogs.Blogs.Entities.Blog", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("Liuliu.Blogs.Blogs.Entities.Post", b =>
                {
                    b.HasOne("Liuliu.Blogs.Blogs.Entities.Blog", "Blog")
                        .WithMany()
